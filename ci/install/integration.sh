...
asset_path="${HOME}/.cache/binaries/kubectl"
...
asset_path="${HOME}/.cache/binaries/minikube"
...
asset_path="${HOME}/.cache/binaries/helm.tar.gz"
...
asset_path="${HOME}/.cache/binaries/svcat"
